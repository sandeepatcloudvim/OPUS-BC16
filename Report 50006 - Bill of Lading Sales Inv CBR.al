report 50006 "Bill of Lading Sales Invoice"
{
    DefaultLayout = RDLC;
    RDLCLayout = './BillofLading.rdl';
    Caption = 'Bill of Lading Sales Inv';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Shipment_Method_Code; "Sales Invoice Header"."Shipment Method Code")
                    {
                    ...
                    column(Project; "Sales Invoice Header".Project)
                    {
                    ...
                    column(Package_Tracking_No_; "Sales Invoice Header"."Package Tracking No.")
                    {
                    ...
                    dataitem(SalesInvLine; "Integer")
                    {
                        ...
                        column(LineNo; TempSalesInvoiceLine."Line No.")
                        {
                        ...
                        column(CustomerText; TempSalesInvoiceLine."Customer Text")
                        {
