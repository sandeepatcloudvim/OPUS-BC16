report 50001 "Purchase Order CBR"
{
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem("Purchase Line"; "Purchase Line")
            {
                ...
                column(LineNo_PurchLine; Format("Line No." / 10000))
                {
                }
                ...
                column(Promised_Receipt_Date; FORMAT("Promised Receipt Date"))
                {
                ...
                column(DirUnitCost_PurchLine; FORMAT("Direct Unit Cost", 0, '<Precision,4:4><Standard Format,4>'))
                {
