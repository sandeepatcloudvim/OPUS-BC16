report 50000 "Sales Invoice CBR"
{
    ...
    dataset
    {
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                column(ExternalDocNo; PostedSalesInv."External Document No.")
                {
                ...
                begin
                    ...
                    if ((Type = Type::Item) OR (Type = Type::"Charge (Item)")) AND (Quantity = 0) then
                        CurrReport.Skip();
                    ...
                    if PostedSalesInv.Get("Document No.") then;
